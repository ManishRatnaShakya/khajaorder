...
class EditRestuarant extends Component {
    ...
    onSubmitData(){
        ...
        this.props.onSubmit(data,this.props.match.params.id);

    }
    
     componentDidMount(){
        const datae = this.props.restuarant && this.props.restuarant.filter(d=>d.r_id===this.props.match.params.id)
      
        this.props.restuarant && this.setState({restuarant:datae[0]})
        if(datae){
        if(datae[0].r_available ==="yes"){ 
    ...
    onSuccess(){
        ...
        toastr.success("Restuarant Edited successful");
    ...
    render() {
        ...
        if(this.props.success){
            this.onSuccess()
            return <Redirect to="/view-restuarant"/>
        }
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    ...
                    <Breadcrumbs title="Edit Restuarant" breadcrumbItems={this.state.breadcrumbItems} />
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col md={4}>
                                                                <FormGroup>
                                                                    ...
                                                                    <select className="form-control select2" onChange={(e)=>this.setState({restuarant:{...this.state.restuarant,r_state:e.target.value}})} value={this.state.restuarant.r_state}>
                                                         ...
                                                         {this.state.selectedFiles.length===0 ?<div>
                                                                ...
                                                                <div className="p-2">
                                                                    ...
                                                                    <Col className="col-auto">
                                                                        ...
                                                                        alt={this.state.restuarant.r_logo?this.state.restuarant.r_logo:"no Image"}
                                                                        src={`https://khajaorder.com/korderapi/images/resturants/${this.state.restuarant.r_logo}`}
                                                                        />
                                                                    </Col>
                                                                    <Col>
                                                                        <Link
                                                                        ...
                                                                        >
                                                                        {this.state.restuarant.r_logo}
                                                                        </Link>
                                                                        <p className="mb-0">
                                                                        {this.state.restuarant.r_logo && '300 KB'}
                                                                        </p>
                                                                    </Col>
                                                                    </Row>
                                                                </div>
                                                         ...
                                                         {this.state.selectedFilesCover.length===0 ?<div>
                                                                ...
                                                                <div className="p-2">
                                                                    ...
                                                                    <Col className="col-auto">
                                                                        ...
                                                                        height="80"
                                                                        className="avatar-sm rounded bg-light"
                                                                        alt={this.state.restuarant.r_cover?this.state.restuarant.r_cover:"no Image"}
                                                                        src={`https://khajaorder.com/korderapi/images/resturants/${this.state.restuarant.r_cover}`}
                                                                        />
                                                                    </Col>
                                                                    <Col>
                                                                        <Link
                                                                        ...
                                                                        className="text-muted font-weight-bold"
                                                                        >
                                                                        {this.state.restuarant.r_cover}
                                                                        </Link>
                                                                        <p className="mb-0">
                                                                        {this.state.restuarant.r_cover && '300 KB'}
                                                                        </p>
                                                                    </Col>
                                                                    </Row>
                                                                </div>
...
const mapDispatchToProps =(dispatch)=>{ 
    return {
        ...
        onSubmit:(data,id)=>dispatch(editRestuarantData(data,id)),
    }
}
...
export default compose(withConnect)(EditRestuarant);