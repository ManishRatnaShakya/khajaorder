                 ...
                 <div id="sidebar-menu">
                        <ul className="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="/add-item">{this.props.t('Add Items')}</Link></li>
                            ...
                            <li>
                                ...
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="/customers-report">{this.props.t('Customers Report')}</Link></li>
                                    <li><Link to="/orders-report">{this.props.t('Order Report')}</Link></li>
                                    <li><Link to="/customer-report">{this.props.t('Customer Wise sales Report')}</Link></li>
                                    <li><Link to="/restuarant-report">{this.props.t('Restuarant Wise Sales Report')}</Link></li>
                                    <li><Link to="/product-report">{this.props.t('Product Wise Sales Report')}</Link></li>
                             ...
                             <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    <i className="ri-store-2-line"></i>
                                    <span className="ml-1">{this.props.t('Restuarant')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="/add-restuarant">{this.props.t('Add Restuarant')}</Link></li>
